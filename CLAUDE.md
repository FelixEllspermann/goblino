...
- Build Hut (+pop cap), Barracks (trains Club + Archer + Speargoblin), **Docks** (coastal, trains Boats), or **Tower** (Defense — auto-fires arrows at hostile units in range once built) — Farmer selects, right-click building card, click to place, Farmer constructs it. Costs are asset-driven (`BuildingDefinition`).
